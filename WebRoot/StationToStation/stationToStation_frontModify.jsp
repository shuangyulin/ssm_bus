		...
		<div class="row"> 
		  ...
		  <div class="form-group">
			  ...
			  <div class="form-group">
			  	...
			  	<span onclick="ajaxStationToStationModify();" class="btn btn-primary bottom5 top5">修改</span>
			  </div>
		</form> 
...
$(function(){
        ...
        new WOW().init();
    stationToStationEdit("<%=request.getParameter("id")%>");
 })
 </script> 
</body>
</html>
