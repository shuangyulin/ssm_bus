...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>StationToStation/frontlist">站站查询信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">记录编号:</div>
		<div class="col-md-10 col-xs-6"><%=stationToStation.getId()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">起始站:</div>
		<div class="col-md-10 col-xs-6"><%=stationToStation.getStartStation().getStationName() %></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">终到站:</div>
		<div class="col-md-10 col-xs-6"><%=stationToStation.getEndStation().getStationName() %></div>
	</div>
	<div class="row bottom15">
